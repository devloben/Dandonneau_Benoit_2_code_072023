...
1. Créez un base de données [mongoDB](https://www.mongodb.com/) contenant deux collections : 
   - books
   - users
1. Téléchargez dans le dossier le backend - [Code du backend sur GitHub]
1. Remonez le fichier `.env.example` en `.env` et compléter les champs avec vos données de connection à la base de données.
